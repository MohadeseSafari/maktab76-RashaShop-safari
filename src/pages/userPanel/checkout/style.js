...
import checkoutBackground from 'assets/image/background/EcommerceCheckoutLaptop.gif';
const grey = {
    20: '#ffffffd0',
    50: '#f7f8fa',
    100: '#dfe3e9',
...
export const PaymentButton = styled(ButtonUnstyled)(({ theme }) => `
  width: 10rem;
  font-weight: bold;
  font-size: 1.45rem;
  font-family: ${theme.typography.fontFamily};
...
export const containerCheckoutForm = {

...
import { Box, Button, Chip, FormControl, FormHelperText, Grid, TextField, Typography, Stack, Select, InputLabel, MenuItem, OutlinedInput } from '@mui/material';
                    ...
                    {(props) => (
                        ...
                        <Form autoComplete='false' >
                            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                                ...
                                <Grid item xs={12}>
                                    <CKEditor editor={ClassicEditor} onChange={(event, editor) => props.setFieldValue("description", editor.getData())} />
                                </Grid>
